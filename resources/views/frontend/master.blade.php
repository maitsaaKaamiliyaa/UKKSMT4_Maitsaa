                            ...
                            <div class="row justify-content-start">
                                <div class="col-lg-8 text-start">
                                    ...
                                    <h1 class="display-1 text-white mb-5 animated slideInRight">The Farm of Dairy
                                        products</h1>
                                        <a href="/login" class="btn btn-secondary rounded-pill py-3 px-5 animated slideInRight">Login</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item rounded p-4">
                        <img class="img-fluid rounded mb-4" src="{{ asset ('assets/img/team-1.jpg') }}" alt="">
                        <h5>Adam Crew</h5>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item rounded p-4">
                        <img class="img-fluid rounded mb-4" src="{{ asset ('assets/img/team-2.jpg') }}" alt="">
                        <h5>Doris Jordan</h5>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item rounded p-4">
                        <img class="img-fluid rounded mb-4" src="{{ asset ('assets/img/team-3.jpg') }}" alt="">
                        <h5>Jack Dawson</h5>
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="testimonial-img">
                        ...
                        <img class="img-fluid animated pulse infinite" src="{{ asset ('assets/img/testimonial-4.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="owl-carousel testimonial-carousel">
                        <div class="testimonial-item">
                            <img class="img-fluid mb-3" src="{{ asset ('assets/img/testimonial-1.jpg') }}" alt="">
                        ...
                        <div class="testimonial-item">
                            <img class="img-fluid mb-3" src="{{ asset ('assets/img/testimonial-2.jpg') }}" alt="">
                            <p class="fs-5">Dolores sed duo clita tempor justo dolor et stet lorem kasd labore dolore
                                lorem ipsum. At lorem lorem magna ut et, nonumy et labore et tempor diam tempor erat.
                            </p>
                            <h5>Client Name</h5>
                        ...
                        <div class="testimonial-item">
                            <img class="img-fluid mb-3" src="{{ asset ('assets/img/testimonial-3.jpg') }}" alt="">
                            <p class="fs-5">Dolores sed duo clita tempor justo dolor et stet lorem kasd labore dolore
                                lorem ipsum. At lorem lorem magna ut et, nonumy et labore et tempor diam tempor erat.
                            </p>
                            <h5>Client Name</h5>
                        ...
                        <div class="testimonial-item">
                            <img class="img-fluid mb-3" src="{{ asset ('assets/img/testimonial-4.jpg') }}" alt="">
                            <p class="fs-5">Dolores sed duo clita tempor justo dolor et stet lorem kasd labore dolore
                                lorem ipsum. At lorem lorem magna ut et, nonumy et labore et tempor diam tempor erat.
                            </p>
                            <h5>Client Name</h5>
