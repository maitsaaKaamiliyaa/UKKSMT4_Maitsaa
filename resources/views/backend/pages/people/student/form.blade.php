...
<div class="app-hero-header">
    ...
    <h3 class="fw-light mb-5">
        <span>Home</span> / <span>Student</span> / <span>Tambah</span>
    </h3>
</div>
                            ...
                            <div class="row justify-content-between">
                                <div class>
                                    ...
                                    <div class="card-header">
                                        <h5 class="card-title">Form Tambah Student</h5>
                                    </div>
                                        <div class="card-body">
                                            <!-- Row start -->
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <label class="form-label" for="inputIdSiswa">NIS</label>
                                                            <input
                                                            type="text"
                                                            class="form-control"
                                                            id="inputIdSiswa"
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="exampleSelectJurusan">NISN</label>
                                                            <input
                                                            type="text"
                                                            class="form-control"
                                                            id="inputIdSiswa"
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label" for="exampleSelectJurusan">Saldo</label>
                                                            <input
                                                            type="number"
                                                            class="form-control"
                                                            id="inputIdSiswa"
